...
footerContainer.innerHTML = `
  <span>&copy; 2026 — Developed by</span>
  ...
  <span>y</span>
  <a href="https://github.com/aaronvalera" target="_blank" rel="noopener noreferrer" class="hover:text-sky-400 font-medium transition-colors duration-200 px-1 py-0.5 rounded-sm hover:bg-slate-800/30">Aaron Valera</a>
`;
